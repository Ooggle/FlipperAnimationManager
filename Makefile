...
IMGUI_DIR = lib/imgui
SRC_DIR = src
SOURCES = $(SRC_DIR)/main.cpp $(SRC_DIR)/heatshrink_decoder.c $(SRC_DIR)/Animation.cpp $(SRC_DIR)/AnimationWallet.cpp $(SRC_DIR)/Manifest.cpp $(SRC_DIR)/file_browser/ImGuiFileBrowser.cpp
